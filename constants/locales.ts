...
export const PROMPT_1920 = "Please generate a photograph of the persons in this image, reimagining them as if they were living in the 1920 , specifically with a Great Gatsby aesthetic. This should be a portrait shot, showing them from the waist up or closer, but ensuring it is not a full-body view. It is important to style them with the distinct fashion and a characteristic hairstyle from that specific era. Do not hesitate to use well-known and even cliché visual elements from the 1920 to make it recognizable. The final image must look like a clear, authentic photograph from that time, capturing the era's signature atmosphere, color palette, and film quality.";
export const PROMPT_2020 = "Please generate a photograph of the persons in this image, reimagining them as if they were living in the 2020. This should be a portrait shot, showing them from the waist up or closer, but ensuring it is not a full-body view. They are taking a selfie, and we can see the back of the mobile phone in the shot, with them looking at the phone screen The phone is highly detailed product shot of the Google Pixel 5 released in 2020, showing its Sorta Sage green textured bio-resin back panel. Ensure it correctly depicts the square dual-lens rear camera bump. It is important to style them with the distinct fashion and a characteristic hairstyle from that specific era. Do not hesitate to use well-known and even cliché visual elements from the 2020 to make it recognizable. The final image must look like a clear, authentic photograph from that time, capturing the era's signature atmosphere, color palette, and film quality.";